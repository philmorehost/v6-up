<?php
    ...
    if(in_array($product_name, array_keys($data_service_provider_alter_code))){
        if($product_name == "mtn"){
            $web_data_size_array = array("500mb_awoof_data" => "500mb_awoof_data","1gb_awoof_data" => "1gb_awoof_data","2gb_awoof_data" => "2gb_awoof_data","3gb_awoof_data" => "3gb_awoof_data","5gb_awoof_data" => "5gb_awoof_data","500mb_data_coupons" => "500mb_data_coupons","1gb_data_coupons" => "1gb_data_coupons","2gb_data_coupons" => "2gb_data_coupons","3gb_data_coupons" => "3gb_data_coupons","5gb_data_coupons" => "5gb_data_coupons");
        }else{
            if($product_name == "airtel"){
                $web_data_size_array = array("300mb_awoof_data","1gb_awoof_data","2gb_awoof_data","3gb_awoof_data","10gb_awoof_data","15gb_awoof_data");
            }else{
                if($product_name == "glo"){
        ...
        if(in_array($quantity, array_keys($web_data_size_array))){
            ...
            $curl_postfields_data = json_encode(array("api_key"=> $api_detail["api_key"],"network"=> $product_name,"phone_number"=> $phone_no,"type"=> "shared-data", "quantity"=>$web_data_size_array[$quantity]), true);
