<?php
    ...
    if(in_array($product_name, array_keys($data_service_provider_alter_code))){
        if($product_name == "startimes"){
            $web_cable_size_array = array("nova_weekly" => "nova-weekly", "basic_weekly" => "basic-weekly", "smart_weekly" => "smart-weekly", "classic_weekly" => "classic-weekly", "super_weekly" => "super-weekly", "nova" => "nova", "basic" => "basic", "smart" => "smart", "classic" => "classic", "super" => "super", "chinese_dish" => "uni-1", "nova_antenna" => "uni-2");
    		$vtpass_isp_code = "startimes";
        }else{
            if($product_name == "dstv"){
                $web_cable_size_array = array("padi"=>"dstv-padi","yanga"=>"dstv-yanga","confam"=>"dstv-confam","compact"=>"dstv79","premium"=>"dstv3","padi_extraview"=>"padi-extra","yanga_extraview"=>"yanga-extra","confam_extraview"=>"confam-extra","compact_extra_view"=>"dstv30","compact_plus"=>"dstv7","compact_plus_extra_view"=>"dstv45","compact_plus_frenchplus_extra_view"=>"complus-french-extraview","premium_extra_view"=>"dstv33","premium_french_extra_view"=>"dstv62");
