...
<body>
    ...
    <div class="card info-card px-5 py-5">
              <form method="post" action="">
                ...
                <input style="text-align: center;" id="phone-number" name="phone-number" onkeyup="tickDataCarrier(); resetDataQuantity();" type="text" value="" placeholder="Phone number e.g 08124232128" pattern="[0-9]{11}" title="Charater must be an 11 digit" class="form-control mb-1" required/><br/>
