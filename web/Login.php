...
<body>	
    <div style="text-align: center;" class="container h-100 d-flex flex-column flex-lg-row">
        ...
        <div class="col-10 col-lg-6 justify-content-center align-self-center d-inline-block">
          <span style="user-select: auto;" class="fw-bold h4">ACCOUNT LOGIN</span><br>
          <form method="post" action="">
              <input style="text-align: center; text-transform: lowercase;" name="user" type="text" value="" placeholder="Username" pattern="[a-zA-Z]{6,}" title="Username must be atleast 6 lowercase letters long (No Space)" class="form-control mt-4 mb-1" autocomplete="on" required/><br/>
              ...
              <button id="" name="login" type="submit" style="user-select: auto;" class="btn btn-primary col-12 mb-5" >
                  LOGIN
              </button><br/>
