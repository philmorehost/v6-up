                                            ...
                                            if ((userBalance(1) >= $amount) && !empty($amount) && is_numeric($amount)) {
                                                if (($product_table["status"] == 1) && ($product_status_table["status"] == 1)) {
                                                    if (productIDBlockChecker($customer_id) == "success") {
                                                        if (productIDPurchaseChecker($customer_id, "betting") == "success") {
                                                            ...
                                                            $json_response_array = array("status" => "failed", "desc" => "Error: Daily Limit Exceeded For This Customer Number: " . $customer_id . ", Contact Admin for Support");
                                                            $json_response_encode = json_encode($json_response_array, true);
                                                        }
                                                    } else {
