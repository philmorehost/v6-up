...
<head>
  ...
  <link href="../assets-2/css/style.css" rel="stylesheet">
                  <!-- Vendor CSS Files -->
  <link href="../cssfile/template/juicyway.css" rel="stylesheet">
	...
	<div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Int'l Money Transfer</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex align-items-center">
                            <div class="card-icon rounded-circle d-flex align-items-center justify-content-center">
                                <img src="https://img.icons8.com/color/48/000000/tether.png" alt="USDT" width="32">
                            </div>
                            <div class="ps-3">
                                <h6>USDT</h6>
                            </div>
                            <div class="card-icon rounded-circle d-flex align-items-center justify-content-center ms-auto">
                                <img src="https://img.icons8.com/color/48/000000/usd-coin.png" alt="USDC" width="32">
                            </div>
                            <div class="ps-3">
                                <h6>USDC</h6>
                            </div>
