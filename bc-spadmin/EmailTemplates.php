      ...
      <div class="col-12">
		...
		<span style="user-select: auto;" class="text-dark h5">VENDOR WELCOME/ACTIVATED TEMPLATE</span><br>
			...
			<div style="text-align: center;" class="container">
                ...
                <textarea style="text-align: left; resize: none;" id="" name="body" onkeyup="" placeholder="Email Body" class="form-control mb-1" rows="10" required><?php echo getSuperAdminEmailTemplate('vendor-welcome-activated','body'); ?></textarea><br>
			<button name="update-template" type="submit" style="user-select: auto;" class="btn btn-success col-12 mb-1" >
				UPDATE TEMPLATE
			</button><br>
		</form>
