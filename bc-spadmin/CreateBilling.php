    ...
    <section class="section dashboard">
      ...
      <div class="card info-card px-5 py-5">
        <form method="post" enctype="multipart/form-data" action="">
            ...
            <input style="text-align: center;" name="type" type="text" value="" placeholder="Billing Type e.g Maintenance Fee" class="form-control mb-1" required/><br/>
            
            <div style="text-align: center;" class="container">
                <span id="api-status-span" class="h5" style="user-select: auto;">BILLING AMOUNT</span>
            </div><br/>
            <input style="text-align: center;" name="amount" type="number" value="" placeholder="Amount" step="0.0001" min="1" class="form-control mb-1" required/><br/>
            <div style="text-align: center;" class="container">
                <span id="api-status-span" class="h5" style="user-select: auto;">STARTING DATE</span>
            </div><br/>
            <input style="text-align: center;" name="starting-date" type="date" value="" placeholder="" class="form-control mb-1" required/><br/>
            
            <div style="text-align: center;" class="container">
                <span id="api-status-span" class="h5" style="user-select: auto;">ENDING DATE</span>
            </div><br/>
            <input style="text-align: center;" name="ending-date" type="date" value="" placeholder="" class="form-control mb-1" required/><br/>
            ...
            <button name="create-billing" type="submit" style="user-select: auto;" class="btn btn-primary col-12 mb-1" >
                CREATE BILLING
            </button><br>
        </form>
    </div>
